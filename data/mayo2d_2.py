...
class Mayo2d_2(SRData):
    ...
    def __init__(self, args, name='mayo2d', is_train=True, is_valid=False):
        super(Mayo2d_2, self).__init__(
    ...
    def _scan(self):
        ...
        videos = (videos_lr, videos_hr, videos_maskE1, videos_maskE2, videos_maskNE) 
