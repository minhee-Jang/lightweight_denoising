...
class Moving700(SRData):
    ...
    def __init__(self, args, name='moving700', is_train=True, is_valid=False):
        super(Moving700, self).__init__(
    ...
    def _set_filesystem(self, data_dir):
        self.apath =  '../../../data/video-sr/moving700'

        self.dir_lr = os.path.join(self.apath, 'test', 'low')
        self.dir_hr = os.path.join(self.apath, 'test', 'high')
        self.dir_mf = os.path.join(self.apath, 'test', 'mf')
        self.dir_rf = os.path.join(self.apath, 'test', 'rf')
