...
class mayo_forover2(SRData):
    ...
    def __init__(self, args, name='mayo_forover', is_train=True, is_valid=False):
        super(mayo_forover2, self).__init__(
    ...
    def _set_filesystem(self, data_dir):
        ...
        self.dir_lr = os.path.join(self.apath, self.mode, 'over2', 'quarter_1mm')
        self.dir_hr = os.path.join(self.apath, self.mode, 'over2', 'full_1mm')
        self.dir_maskE1 = os.path.join(self.apath, self.mode, 'over2','3_mask_160', 'Edge1')
        self.dir_maskE2 = os.path.join(self.apath, self.mode,'over2','3_mask_160',  'Edge2')
        self.dir_maskNE = os.path.join(self.apath, self.mode, 'over2','3_mask_160', 'NEdge')
