...
def save_metrics(path, noise_loss, noise_psnr, noise_ssim, rf_loss, rf_psnr, rf_ssim, mf_loss, mf_psnr, mf_ssim, out_loss, out_psnr, out_ssim):
    report_path = os.path.join(path, 'report_0803_withfsaunet_moving700_3.csv')
...
if __name__ == '__main__':
    ...
    # test_dir = opt.test_results_dir + '-psnr/day_10000mean2_thredynamic_gau5.3_rf0.4new5frames_moving700_4'
    test_dir = opt.test_results_dir + '-psnr/0803_withfsaunet_moving700_3_nosquare'
