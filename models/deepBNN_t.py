...
#         self.conv2 = nn.Conv2d(4, 16, kernel_size=(3,3),stride=(1,1),padding=(1,1),bias=False)
#         self.conv3 = nn.Conv2d(16, 64, kernel_size=(3,3),stride=(1,1),padding=(1,1),bias=False)
...
class BilaterlDeepNet(nn.Module):
    def __init__(self, opt):
        ...
        deep_bnn = [create_bnn(opt) for _ in range(16)]
        
        

        self.feature_extractor = nn.Conv3d(1, 16, kernel_size=(1,3,3), padding=(0,1,1),bias=False)
        self.deep_bnn = nn.ModuleList(deep_bnn)
        self.reconstructor=nn.Conv3d(16, 1, kernel_size=(1,3,3), padding=(0,1,1),bias=False )
